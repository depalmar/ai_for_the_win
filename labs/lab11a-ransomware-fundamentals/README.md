...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/depalmar/ai_for_the_win/blob/main/notebooks/lab11a_ransomware_fundamentals.ipynb)
...
```
lab11a-ransomware-fundamentals/
├── README.md
├── starter/
...
- [Unit 42 Ransomware Research](https://unit42.paloaltonetworks.com/)
...
> 🌉 **Bridge Lab**: This lab provides the foundational knowledge needed for Lab 11 (Ransomware Detection) where you'll build actual detection algorithms using entropy analysis, behavioral patterns, and ML/LLM techniques.

**Next Lab**: [Lab 11 - Ransomware Detection](../lab11-ransomware-detection/)
