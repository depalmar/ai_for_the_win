...
- **Vulnerability exploitation is now the top way in.** Verizon's *2026 Data Breach Investigations Report* (31,000+ incidents across 145 countries) found software-flaw exploitation **(31%) overtook stolen credentials** as the leading breach vector for the first time, with AI compressing the path from disclosure to exploitation **"from months to hours."**¹⁰
- **Shadow AI widened the attack surface.** In the same DBIR, regular employee use of unsanctioned AI tools **tripled to 45%**, and mobile social-engineering success rose **40%**.¹⁰
...
**EU AI Act - the dates a security leader actually needs.** Obligations phase in over several years, and the calendar is still moving: the *Digital Omnibus* package (proposed November 2025, with political agreement reached in May 2026) is shifting several high-risk deadlines and tying them to when supporting standards and guidance are available. Confirm specifics with counsel - but as of mid-2026 the shape of the calendar is:
...
timeline
    ...
    2026-2027 : High-risk (Annex III) obligations begin to apply (date being adjusted by Digital Omnibus)
    Through 2028 : Embedded-product high-risk obligations phase in (extended transition)
```
...
There's an uncomfortable trend running underneath everything above: even as attacks accelerate, security teams are being cut, with AI cited as the justification. In Mercer's 2026 *Global Talent Trends* survey, **99% of executives said they expect AI to drive at least some headcount reduction within two years**,⁸ and several security vendors ran 2025–2026 layoffs that explicitly named "AI efficiency" as a reason.

The workforce data says proceed carefully. The **2025 ISC2 Cybersecurity Workforce Study** still puts the global talent gap near **4.8 million**, with **500K+ open roles in the US alone**, and for the first time, **budget cuts (not talent scarcity) are the top reported cause of the shortage**.⁷ In other words, much of the "AI is replacing analysts" narrative is really cost-cutting wearing an AI label; independent analysis finds many of these cuts show no clear business case.
...
- [Verizon, *2026 Data Breach Investigations Report*](https://www.verizon.com/business/resources/reports/dbir/) - 31,000+ incidents; vulnerability exploitation (31%) overtakes stolen credentials; AI-assisted technique analysis of 793 threat actors (with Anthropic); shadow-AI use tripled to 45% _(superscript ¹⁰)_
...
- [ISC2, *2025 Cybersecurity Workforce Study*](https://www.isc2.org/Insights/2025/12/2025-ISC2-Cybersecurity-Workforce-Study) - ~4.8M global talent gap, budget cuts now the top driver of the shortage, skills need outpacing headcount _(superscript ⁷)_
- [Mercer, *2026 Global Talent Trends*](https://www.mercer.com/insights/people-strategy/future-of-work/global-talent-trends/) - 99% of executives expect AI to drive at least some headcount reduction within two years _(superscript ⁸)_
