# Lab 01 Walkthrough: Python for Security Fundamentals
...
Continue to [Lab 04: ML Concepts Primer](./lab04-ml-concepts-primer-walkthrough.md) to understand machine learning fundamentals before coding.
